 ...
 * though in order to keep resource usage and complexity to a minimum. All I/O operations are done asynchronously and as a
 * result only one thread is needed per {@code LocalBotGroup}.
 *
